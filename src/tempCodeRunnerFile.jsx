        ...
        <div className="form-side" >
          <div className="form-side-inner-div">
            ...
            <div className="form-buttons-box">
                ...
                <Button className="form-button" style={{backgroundColor:'#1472E5',height:'48px'}} type="primary" block>Log in</Button>
                <Divider>or</Divider>
                <Button className="form-button" style={{height:'48px'}} block>Log in with   <img style={{marginLeft:'10px'}} src={googleSVG} /></Button>
                </div>
            </div>
          </div>
        </div>
